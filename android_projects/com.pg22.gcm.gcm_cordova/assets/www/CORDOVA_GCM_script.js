...
document.addEventListener('deviceready', function() {
  ...
  //
  window.GCM.register("46997187553", "GCM_Event", GCM_Success, GCM_Fail );
...
GCM_Success(e)
{
  $("#app-status-ul").append('<li>GCM_Success -> We have successfully registered and called the GCM plugin, waiting for GCM_Event:registered -> REGID back from Google</li> ' + JSON.stringify(e));
